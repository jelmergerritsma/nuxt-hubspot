...
<template>
  <div>
    ...
    <div
      v-if="items.length === 0 && !completed"
      class="card"
      style="max-width: 360px; text-align: center; padding: 32px 16px;"
    >
      ...
      <NuxtLink
        to="/products"
        style="color: #00dc82; font-size: 14px; text-decoration: none;"
      >
        Browse products →
      </NuxtLink>
    </div>
    ...
    >
      ...
      <NuxtLink
        to="/products"
        style="color: #888; font-size: 13px; text-decoration: none; display: inline-block; margin-top: 12px;"
      >
        Continue shopping →
      </NuxtLink>
    </div>
